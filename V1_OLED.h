...
void OLED_setup() {
  Wire.setSDA(OLED_sdaPin);                // OLED is connected via I2C. set the SDA
  Wire.setSCL(OLED_sclPin);                // and SCL pins first before starting the object.
